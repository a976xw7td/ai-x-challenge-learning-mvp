...
export const portfolioItems: PortfolioItem[] = [
  { id: "pf-001", studentName: "张三", studentId: "s01", challengeTitle: "构建你的第一个 AI 助手", challengeId: "c01", summary: "做了一个「编程入门助手」，帮助大一新生快速了解 AI+X 课程体系。从需求定义到 AI 生成原型，再到多轮迭代优化，完整展示了人机协作的流程。", techStack: ["HTML/CSS/JS", "AI Prompt Engineering", "DeepSeek"], demoUrl: "https://first-ai-assistant.vercel.app", githubRepo: "zhangsan-dev/first-ai-assistant", aiScore: 88, teacherScore: 90, isPublic: true, submittedAt: "2026-07-05" },
  ...
  { id: "pf-003", studentName: "张三", studentId: "s01", challengeTitle: "AI 结对编程入门", challengeId: "c02", summary: "通过 AI 结对编程完成了一个计算器应用，展示了完整的「你思考→AI 写代码→你审查→一起迭代」流程。代码审查记录是很好的学习材料。", techStack: ["Python", "AI 辅助编程", "Claude Code"], githubRepo: "zhangsan-dev/ai-pair-calc", aiScore: 92, teacherScore: 93, isPublic: true, submittedAt: "2026-07-03" },
